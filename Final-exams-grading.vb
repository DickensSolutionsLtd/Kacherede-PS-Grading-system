Public Class Final_exams_grading
    ...
    Private Sub btngrade_Click(sender As Object, e As EventArgs) Handles btngrade.Click
        ...
        If scb(3) + sb(3) + mb(3) + eb(3) < 100 Then
    ...
    Private Sub Final_gradingBindingNavigatorSaveItem_Click(sender As Object, e As EventArgs)
        Me.Validate()
    ...
    Private Sub Final_exams_grading_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        one = EnglishTextBox.Text
        two = MathsTextBox.Text
        three = SSTTextBox.Text
        four = ScienseTextBox.Text

        TotalTextBox.Text = (one + two + three + four)

        Final_gradingBindingSource.EndEdit()
        TableAdapterManager.UpdateAll(_grading_systemDataSet)
        MsgBox("Added Succesfully!")

    End Sub

    Private Sub Final_gradingBindingNavigatorSaveItem_Click_1(sender As Object, e As EventArgs)
        Me.Validate()
        Me.Final_gradingBindingSource.EndEdit()
        Me.TableAdapterManager.UpdateAll(Me._grading_systemDataSet)
    End Sub
